...
const MovieCart = ({movie}) => {
  ...
  return (
    <div className='flex flex-col justify-between p-3 bg-gray-700 rounded-2xl
    hover:-translate-y-1 transition duration-300 w-66'>
        <img onClick={()=> {navigate(`/movie/${movie._id}`) ; scrollTo(0,0)}}
        src={image_base_url + movie.backdrop_path} alt="" className='rounded-lg h-52 w-full object-cover object-bottom cursor-pointer' />
